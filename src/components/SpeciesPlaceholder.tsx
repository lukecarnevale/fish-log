...
const SIZE_CONFIGS: Record<PlaceholderSize, SizeConfig> = {
  small: {
 ...
 */
const RedDrumSvg: React.FC<{ width: number; height: number }> = ({ width, height }) => (
  <Svg width={width} height={height} viewBox="0 0 120 80">
 ...
 */
const FlounderSvg: React.FC<{ width: number; height: number }> = ({ width, height }) => (
  <Svg width={width} height={height} viewBox="0 0 120 80">
    {/* Main body - flat oval */}
 ...
 */
const SeatroutSvg: React.FC<{ width: number; height: number }> = ({ width, height }) => (
  <Svg width={width} height={height} viewBox="0 0 120 80">
    {/* Main body */}
 ...
 */
const WeakfishSvg: React.FC<{ width: number; height: number }> = ({ width, height }) => (
  <Svg width={width} height={height} viewBox="0 0 120 80">
    {/* Main body - silvery */}
 ...
 */
const StripedBassSvg: React.FC<{ width: number; height: number }> = ({ width, height }) => (
  <Svg width={width} height={height} viewBox="0 0 120 80">
    {/* Main body - silver */}
 ...
 */
const Bubbles: React.FC<{ size: PlaceholderSize }> = ({ size }) => {

...
const TrophyIcon: React.FC<{ color: string; size?: number }> = ({ color, size = 24 }) => (
...
// Fish icon for species category
const FishIcon: React.FC<{ color: string; size?: number }> = ({ color, size = 24 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
// Ruler icon for length category
const RulerIcon: React.FC<{ color: string; size?: number }> = ({ color, size = 24 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
      d="M3 5H21V19H3V5Z"
      stroke={color}
